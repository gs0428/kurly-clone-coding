...
export default function Mid() {
  ...
  return (
    <S.Container>
      <C.FlexWrap>
        <S.KurlyWrap>
          <S.KurlyImg
            ...
            alt="none"
          />
          <S.Kurly loc={"/kurly-clone-coding/" === loc} href="/kurly-clone-coding/">
            마켓컬리
          </S.Kurly>
          <S.Div>|</S.Div>
          <C.FlexWrap>
            <S.Kurly loc={"/kurly-clone-coding/beauty" === loc} href="/kurly-clone-coding/beauty">
              뷰티컬리
            </S.Kurly>
            <S.NImg
        ...
        <S.InputWrap>
          <S.Input placeholder={loc === "/kurly-clone-coding/" ? "검색어를 입력해주세요" : "뷰티 상품을 검색하세요"} />
          <S.Search>
            <BiSearch size={30} />
          </S.Search>
        </S.InputWrap>
      ...
      <C.FlexWrap>
        {icons.map((icon, idx) => (
          <S.IconWrap key={`iconwrap${idx}`}>{icon}</S.IconWrap>
        ))}
      </C.FlexWrap>
    </S.Container>
  );
